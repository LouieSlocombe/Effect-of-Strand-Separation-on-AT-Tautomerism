...
class SeparationAnalysis(object):
    ...
    def plot_barrier_asym(self, f_debug=True):
        ...
        # E_max1[8] = self.e_max1[8]
        # E_max2[8] = self.e_max2[8]
        ...
        # E_max1[8] = self.e_max1[9]
        # E_max2[8] = self.e_max2[9]
        ...
        plt.plot(self.dr, self.e_min1, c="red", ls="dotted", marker="x", label="SPT")  ###
        plt.plot(self.dr[2:], self.e_min2[2:], c="blue", ls="--", marker="o",label="DPT")
...
work_dir = home + r"\OneDrive - Personal\QBQC\A-T_SS\last_predicted\GC" + neb_dir

neb_dir = "\ml_neb_paths_20220518"
neb_dir = "\ml_neb_paths_20220909"
neb_dir = r'\last_predicted'
work_dir = home + r"\OneDrive\QBQC\A-T_SS\last_predicted\GC" + neb_dir
